...
#import "CommonTAPageControl.h"
#import "CommonTAAnimatedDotView.h"
...
@implementation CommonTAPageControl
...
- (void)initialization
{
    self.dotViewClass           = [CommonTAAnimatedDotView class];
...
- (UIView *)generateDotView
{
    ...
    if (self.dotViewClass) {
        ...
        if ([dotView isKindOfClass:[CommonTAAnimatedDotView class]] && self.dotColor) {
            ((CommonTAAnimatedDotView *)dotView).dotColor = self.dotColor;
        }
    } else {
...
{
    if (self.dotViewClass) {
        CommonTAAbstractDotView *abstractDotView = (CommonTAAbstractDotView *)[self.dots objectAtIndex:index];
        if ([abstractDotView respondsToSelector:@selector(changeActivityState:)]) {
            [abstractDotView changeActivityState:active];
        } else {
            NSLog(@"Custom view : %@ must implement an 'changeActivityState' method or you can subclass %@ to help you.", self.dotViewClass, [CommonTAAbstractDotView class]);
        }
